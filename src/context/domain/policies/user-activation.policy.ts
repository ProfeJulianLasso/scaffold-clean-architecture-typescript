 ...
 * Define reglas de negocio relacionadas con el estado de los usuarios
 */
export class UserActivationPolicy {
  /**
   * Verifica si un usuario puede ser activado
   * @param user - Usuario a activar
   * @returns Result con éxito o error
   */
  public static canActivate(user: User): Result<void> {
   ...
   * @returns Result con éxito o error
   */
  public static canDeactivate(user: User): Result<void> {
